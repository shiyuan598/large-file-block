  ...
  >
    <div class="set-height auto">
      ...
      <el-row :gutter="80" class="mt-8">
        ...
        ></el-col>
        <el-col :span="8">
          <el-form-item label="&nbsp;&nbsp;&nbsp;鞍座承载" prop="saddleBear">
            <el-input
              v-model="form.saddleBear"
              placeholder="请输入鞍座承载"
            /> </el-form-item
        ></el-col>
        <el-col :span="8">
          <el-form-item label="&nbsp;&nbsp;&nbsp;鞍座高度" prop="saddleHeight">
            <el-input
              v-model="form.saddleHeight"
              placeholder="请输入鞍座高度"
            /> </el-form-item
        ></el-col>
        <el-col :span="8">
          <el-form-item label="&nbsp;&nbsp;&nbsp;有效载荷" prop="payload">
            <el-input
        ...
        ></el-col>
        <el-col :span="8">
          <el-form-item label="&nbsp;&nbsp;&nbsp;前悬半径" prop="frontRadius">
            <el-input
              v-model="form.frontRadius"
              placeholder="请输入前悬半径"
            /> </el-form-item
        ></el-col>
        <el-col :span="8">
          <el-form-item label="&nbsp;&nbsp;&nbsp;驱动形式" prop="driveForm">
            <el-input
              v-model="form.driveForm"
              placeholder="请输入驱动形式"
            /> </el-form-item
        ></el-col>
        <el-col :span="8">
        ...
        ></el-col>
        <el-col :span="8">
          <el-form-item label-width="124" label="&nbsp;&nbsp;&nbsp;牵引结合面高度" prop="tractionHeight">
            <el-input
              v-model="form.tractionHeight"
              placeholder="请输入牵引结合面高度"
            /> </el-form-item
        ></el-col>
        <el-col :span="8">
          <el-form-item label="&nbsp;&nbsp;&nbsp;整备质量" prop="curbWeight">
            <el-input
              v-model="form.curbWeight"
              placeholder="请输入整备质量"
            /> </el-form-item
        ></el-col>
        <el-col :span="8">
          <el-form-item label="&nbsp;&nbsp;&nbsp;额定载质量" prop="sprungWeight">
            <el-input
              v-model="form.sprungWeight"
...
import {
  getOptions,
  vehicleTractorTractor,
  depreciationCard,
  tractorPuttractor,
} from "@/api/vehicleInfo";
import { State, TractorForm } from "@/api/vehicleInfo/types";
...
const form = reactive<TractorForm>({
  id: undefined,
  card: undefined,
  brand: "",
  business: "",
  ...
  residualRate: 5,
  model: undefined,
  saddleBear: undefined,
  saddleHeight: undefined,
  payload: undefined,
  frontRadius: undefined,
  driveForm: undefined,
  wheelbase: undefined,
  tractionHeight: undefined,
  curbWeight: undefined,
  sprungWeight: undefined,
});
watch(
  [() => form, () => form],
  ([newValue, oldValue]) => {
...
const rules = reactive<FormRules<TractorForm>>({
  card: [
    {
      required: true,
      message: "请输入车牌号码",
...
const getVehicleTractor = async () => {
  try {
    const { data } = await vehicleTractorTractor(form);
...
const editPuttractor = async () => {
  try {
    const { data } = await tractorPuttractor(form, props.editFrom.id);
