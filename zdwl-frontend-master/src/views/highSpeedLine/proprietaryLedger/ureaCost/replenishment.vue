  ...
  <div class="app-container">
    <div class="parkClass">
      ...
      >
        ...
        >
          <span class="span-color">标准尿素量(L)：</span
      ...
      <div style="padding: 10px 20px; width: 100%">
        ...
        >
          ...
          <el-table-column label="尿素单价(元/KG)" align="center">
            <el-table-column
              prop="upPrice"
              label="标准"
              align="right"
          ...
          <el-table-column label="尿素量(KG)" align="center">
            <el-table-column
              prop="upNum"
              label="标准"
              align="right"
          ...
          <!-- <el-table-column prop="location" label="行驶距离（KM）" width="150"/>
          <el-table-column prop="location" label="里程表图片"  width="150">
            <button @click="showImg('https://fuss10.elemecdn.com/8/27/f01c15bb73e1ef3793e64e6b7bbccjpeg.jpeg')">图片</button>
          </el-table-column> -->
        </el-table>
...
import { ureaQuery } from "@/api/highSpeedLine/platformLedger/types";
import {
  getUreaPage,
  exportUrea,
  getUreaStat,
...
const queryParams = reactive<ureaQuery>({
  pageNum: 1,
  pageSize: 10,
});
