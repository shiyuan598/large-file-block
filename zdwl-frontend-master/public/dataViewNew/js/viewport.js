    ...
    function queryOperateMileage(){
      ...
      if (undefined === result) {
        ...
        if (result.code == "00000") {
          //避免出现数据为空的情况
          if (result.data != null) {
            $('#queryOperateMileage').html(Math.ceil((result.data + 10000000)/ 10000));
          }
        } else {
          phoenix.msg.fail(result.message);
        }
  ...
  function queryIntelligentMileage(){
    ...
    if (undefined === result) {
      ...
      if (result.code == "00000") {
        //避免出现数据为空的情况
        if (result.data != null) {
          $('#queryIntelligentMileage').html(Math.ceil((result.data + 8000000)/10000));
          let date = getNowFormatDate()
          $('#headLefNew').html(`截止${date},智能驾驶里程突破${Math.ceil((result.data + 8000000)/10000)}万公里` );
        }
      } else {
        phoenix.msg.fail(result.message);
      }
  ...
  function queryCustom(){
    ...
    if (undefined === result) {
      ...
      if (result.code == "00000") {
        //避免出现数据为空的情况
        if (result.data != null) {
          $('#queryCustom').html(result.data + 100);
        }
      } else {
        phoenix.msg.fail(result.message);
      }
  ...
  function queryRoute(){
    ...
    if (undefined === result) {
      ...
      if (result.code == "00000") {
        //避免出现数据为空的情况
        if (result.data != null) {
          $('#queryRoute').html(Math.ceil(result.data/2));
        }
      } else {
        phoenix.msg.fail(result.message);
      }
