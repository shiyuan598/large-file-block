...
var line1Data = [
    [{name:'苏州'},{name:'青岛',value:100}],
    [{name:'苏州'},{name:'长春',value:200}],
    [{name:'苏州'},{name:'济南',value:300}],
    [{name:'苏州'},{name:'兰州',value:400}],
    [{name:'苏州'},{name:'拉萨',value:500}],
    [{name:'苏州'},{name:'昆明',value:600}],
    [{name:'苏州'},{name:'长沙',value:700}],
    [{name:'苏州'},{name:'东莞',value:800}],
    [{name:'苏州'},{name:'厦门',value:900}],
];
var line2Data = [
    [{name:'佛山'},{name:'昆明',value:10}],
    [{name:'佛山'},{name:'成都',value:11}],
    [{name:'佛山'},{name:'重庆',value:12}],
    [{name:'佛山'},{name:'石家庄',value:13}],
    [{name:'佛山'},{name:'西安',value:14}],
    [{name:'佛山'},{name:'天津',value:15}],
    [{name:'佛山'},{name:'上海',value:16}],
    [{name:'佛山'},{name:'拉萨',value:17}],
    [{name:'佛山'},{name:'杭州',value:18}],
    [{name:'佛山'},{name:'台州',value:19}],
  
];
var line3Data = [
    [{name:'昆明'},{name:'成都',value:20}],
    [{name:'昆明'},{name:'郑州',value:21}],
];
var line4Data = [
